...
import {
  useTheme
} from "./chunk-P7SXB3Q3.js";
import {
  styled_default
} from "./chunk-FPSQ36XS.js";
import {
  ownerWindow,
  useControlled,
  ...
  useForkRef,
  useId
} from "./chunk-TYKUGAL2.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  init_extends
} from "./chunk-AZH2QNB6.js";
import {
  require_prop_types
...
var AnimationContext = React28.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React31.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime9.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime9.jsxs)(React33.Fragment, {
...
function useChartGradient() {
  ...
  return React35.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React36.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React36.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React37.useRef(null);
...
init_extends();
var _excluded5 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className", "experimentalMarkRendering"];
...
//# sourceMappingURL=chunk-OKYU476A.js.map
