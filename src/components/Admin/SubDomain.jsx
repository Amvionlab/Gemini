...
const Form = () => {
  ...
  return (
    <div className="bg-second max-h-5/6 w-full relative text-xs mx-auto lg:overflow-y-hidden h-auto ticket-scroll">
      ...
      <div className="w-full relative m-0.5  bg-box p-1 rounded-lg font-mont">


        {/* Table displaying fetched user data */}
        <div className="ticket-table mt-8">
          <h2 className="text-2xl font-bold text-prime mb-4 flex justify-between items-center p-2">
            ...
            <TableBody>
              {currentTickets.map((user, i) => (
                <TableRow key={user.id} hover>
                  ...
                  <TableCell align="center" style={{ padding: '10px' }} className="border-t">{user.domain_name}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
