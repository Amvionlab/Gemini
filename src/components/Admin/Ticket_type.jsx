...
const Form = () => {
  ...
  return (
    <div className="bg-second max-h-5/6 w-full relative  text-xs mx-auto lg:overflow-y-hidden h-auto ticket-scroll">
      ...
      <div className="w-full relative bg-box p-3 m-0.5 rounded-lg font-mont">
            ...
            <TableBody>
              {currentTickets.map((user, i) => (
                <TableRow key={user.id} className="hover:bg-gray-100">
                  <TableCell className="border-t py-4 px-4" style={{ padding: '10px' }} align="center">{i + offset}</TableCell>
                  <TableCell className="border-t py-4 px-4" style={{ padding: '10px' }} align="center">{user.type}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
