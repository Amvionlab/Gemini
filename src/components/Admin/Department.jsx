              ...
              <TableRow>
                {["Id", "name"].map((header, index) => (
                  <TableCell key={index} align="center" >
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "1.1rem" }}>
                      <span>{header}</span>
            ...
            <TableBody>
              {currentTickets.map((user, i) => (
                <TableRow key={user.id} hover>
                  <TableCell align="center" style={{ padding: '8px' }} className="border-t">{i + 1}</TableCell>
                  <TableCell align="center" style={{ padding: '8px' }} className="border-t">{user.name}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
